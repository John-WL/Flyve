...
public class RlUtils {
    ...
    public static double timeToReachAerialDestination(Vector3 playerDistanceFromDestination, Vector3 playerSpeedFromDestination) {
        ...
        double a = -RlConstants.ACCELERATION_DUE_TO_BOOST/2.5 /*+ (input.car.orientation.noseVector.dotProduct(new Vector3(0, 0, 1))*RlConstants.NORMAL_GRAVITY_STRENGTH/2)*/;
