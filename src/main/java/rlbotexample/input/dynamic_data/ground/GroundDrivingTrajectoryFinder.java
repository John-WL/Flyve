...
public class GroundDrivingTrajectoryFinder {
    ...
    public GroundDrivingTrajectoryFinder(Trajectory3D targetTrajectory, Trajectory3D orientationTrajectory) {
    ...
    public static Trajectory3D getRightTurningTrajectory(ExtendedCarData carData) {
        double radii = MaxTurnRadiusFinder.compute(carData.velocity.magnitude());
