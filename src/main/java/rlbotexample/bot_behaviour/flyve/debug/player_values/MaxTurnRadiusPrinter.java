...
public class MaxTurnRadiusPrinter extends FlyveBot {
    ...
    public BotOutput processInput(DataPacket input, GameTickPacket packet) {
        rightTurn = GroundTrajectoryFinder.getRightTurningTrajectory(input.allCars.get(1-input.playerIndex));
        leftTurn = GroundTrajectoryFinder.getLeftTurningTrajectory(input.allCars.get(1-input.playerIndex));
