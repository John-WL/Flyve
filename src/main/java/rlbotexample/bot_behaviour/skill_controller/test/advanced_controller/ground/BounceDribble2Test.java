...
import rlbotexample.bot_behaviour.skill_controller.implementation.advanced.offense.ground_dribble.BounceDribble2;
import rlbotexample.input.dynamic_data.DataPacket;
import rlbotexample.input.dynamic_data.goal.StandardMapGoals;
import rlbotexample.output.BotOutput;
import util.game_situation.trainning_pack.TrainingPack;

public class BounceDribble2Test extends FlyveBot {

    private BounceDribble2 dribbleController;
    private TrainingPack gameSituationHandler;

    public BounceDribble2Test() {
        //gameSituationHandler = new CircularTrainingPack();
        //gameSituationHandler.add(new GroundDribbleSetup1());
        //gameSituationHandler.add(new GroundDribbleSetup2());
        dribbleController = new BounceDribble2(this);
    }
    ...
    public BotOutput processInput(DataPacket input, GameTickPacket packet) {
        ...
        dribbleController.setBallDestination(StandardMapGoals.getOpponent(input.team).closestPointOnSurface(input.ball.position));
