...
public class AerialDirectionalHit6Test extends FlyveBot {

    private AerialDirectionalHit6 aerialDirectionalHitController;
    private TrainingPack gameSituationHandler;
    private Predictions predictions;

    public AerialDirectionalHit6Test() {
        aerialDirectionalHitController = new AerialDirectionalHit6(this);
