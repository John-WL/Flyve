...
public class AerialOrientation6Test extends FlyveBot {

    private AerialOrientationController6 aerialOrientationController5;
    ...
    public AerialOrientation6Test() {
        gameSituationHandler = new CircularTrainingPack();
        gameSituationHandler.add(new AerialOrientationTesterSetup());
        aerialOrientationController5 = new AerialOrientationController6(this);
    }
