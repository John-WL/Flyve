...
public class AerialOrientation5Test extends FlyveBot {

    private AerialOrientationController5 aerialOrientationController5;
    ...
    public AerialOrientation5Test() {
        //gameSituationHandler = new CircularTrainingPack();
        //gameSituationHandler.add(new AerialOrientationTesterSetup());
        aerialOrientationController5 = new AerialOrientationController5(this);
    }
