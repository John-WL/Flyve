package rlbotexample.bot_behaviour.skill_controller.implementation.advanced.aerial.setup;

import rlbot.render.Renderer;
import rlbotexample.bot_behaviour.metagame.advanced_gamestate_info.AerialInfo;
import rlbotexample.bot_behaviour.flyve.BotBehaviour;
import rlbotexample.bot_behaviour.skill_controller.SkillController;
import rlbotexample.bot_behaviour.skill_controller.implementation.advanced.aerial.directionnal_hit.parabola.AerialDirectionalHit5;
    ...
    private Vector3 playerAerialTrajectory(double timeInTheFuture, DataPacket input) {
        ...
        if(timeInTheFuture < timeToReachDesiredOrientation) {
            ...
            Parabola3D continuation = new Parabola3D(jumpPhaseTrajectory.apply(timeToReachDesiredOrientation),
                    ...
                    new Vector3(0, 0, RlConstants.ACCELERATION_DUE_TO_BOOST_IN_AIR - RlConstants.NORMAL_GRAVITY_STRENGTH),
                    0);
