...
public class AerialDirectionalHit4 extends SkillController {
    ...
    private Vector3 findPlayerOrientation(DataPacket input) {
        ...
        naiveOrientationGuess = naiveOrientationGuess.plus(input.car.velocity.scaledToMagnitude(-futureBallPosition.minus(futureCarPosition).magnitude()/700)).normalized();
