...
@Deprecated
public class WeakDribble5 extends SkillController {
    ...
    public WeakDribble5(BotBehaviour bot) {
    ...
    public void debug(Renderer renderer, DataPacket input) {
        ...
        shapeRenderer.renderTrajectory(trajectoryOfPointOnRightCircleToAlign, 3, Color.GREEN);
