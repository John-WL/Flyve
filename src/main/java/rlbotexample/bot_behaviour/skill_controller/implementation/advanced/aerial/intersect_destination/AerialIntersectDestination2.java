package rlbotexample.bot_behaviour.skill_controller.implementation.advanced.aerial.intersect_destination;
...
public class AerialIntersectDestination2 extends SkillController {
    ...
    public void updateOutput(DataPacket input) {
        ...
        double lengthOfVector = RlConstants.NORMAL_GRAVITY_STRENGTH + ((1 - Math.cos(angleFromZCoordinate)) * (RlConstants.ACCELERATION_DUE_TO_BOOST_IN_AIR - RlConstants.NORMAL_GRAVITY_STRENGTH));
