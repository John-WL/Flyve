package rlbotexample.bot_behaviour.skill_controller.implementation.advanced.offense.ground_hit.ground_directional_hit_6;

import rlbot.render.Renderer;
import rlbotexample.bot_behaviour.flyve.BotBehaviour;
import rlbotexample.bot_behaviour.skill_controller.SkillController;
import rlbotexample.bot_behaviour.skill_controller.implementation.advanced.offense.ground_hit.ground_directional_hit_6.state.InitializationState;
import rlbotexample.input.dynamic_data.DataPacket;
import rlbotexample.input.prediction.Trajectory3D;
import util.state_machine.StateMachine;

public class GroundDirectionalHit6 extends SkillController {

    private final StateMachine stateMachine;
    private final InitializationState initializationState;

    public GroundDirectionalHit6(BotBehaviour bot) {
