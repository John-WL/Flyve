...
public class DoubleWaveDash extends JumpType {

    private static final double REMAINING_DISTANCE_BETWEEN_CHASSIS_AND_GROUND_WHEN_DASHING = 42;
    ...
    public DoubleWaveDash(BotBehaviour bot, DataPacket input) {
