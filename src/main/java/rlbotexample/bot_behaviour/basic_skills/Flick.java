...
import rlbotexample.bot_behaviour.basic_skills.jump.JumpHandler;
import rlbotexample.bot_behaviour.basic_skills.jump.implementations.Flip;
import rlbotexample.bot_behaviour.basic_skills.jump.implementations.ShortJump;
import rlbotexample.bot_behaviour.basic_skills.jump.implementations.SimpleJump;
...
public class Flick extends SkillController {
    ...
    private static final double PLAYER_DISTANCE_FROM_BALL_WHEN_CONSIDERED_FLICKING = 190;
    ...
    public void updateOutput(DataPacket input) {
        ...
        Vector3 nonUniformScaledPlayerDistanceFromBall = ((playerPosition.minus(ballPosition)).minusAngle(playerNoseOrientation)).scaled(1, 1.3, 0.8);
    ...
    private void updateJumpBehaviour(DataPacket input) {
        ...
        jumpHandler.updateJumpState(
                input,
                output,
                CarDestination.getLocal(ballPosition.scaled(1, 1, 0).plus(playerPosition.scaled(0, 0, 1)), input),
