package rlbotexample.bot_behaviour.basic_skills.competitionwise;
...
import rlbotexample.bot_behaviour.basic_skills.jump.implementations.HalfFlip;
import rlbotexample.bot_behaviour.basic_skills.jump.implementations.SimpleJump;
import rlbotexample.bot_behaviour.basic_skills.jump.implementations.Wait;
import rlbotexample.bot_behaviour.car_destination.CarDestination;
import rlbotexample.bot_behaviour.path.PathHandler;
import rlbotexample.bot_behaviour.path.PredictedBallPositionPath;
...
public class Dribble extends SkillController {
    ...
    private static final double PLAYER_GET_AROUND_THE_BALL_DISTANCE_WHEN_DRIBBLING_LOST = 125;
